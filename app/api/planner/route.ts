...
function topologicalSort(courses: OutputCourse[], courseMap: Record<string, OutputCourse>) {
  //TODO: topo sort helper

  return [];
}

// Function to organize courses into semesters while respecting credit limits
function planner(courses: OutputCourse[]): OutputCourse[][] {
...
export async function GET(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    console.log("meow");
    return NextResponse.json(study_schedule, { status: 200 });
  } catch (error) {
